    ...
    <table class="table">
        <thead>
            <?php switch($tipo_balance):
                ...
                <?php case ('auxiliar_cuentas_detalles'): ?>
                    <tr>
                        <th>FECHA</th>
                        <th>DOCUMENTO</th>
                        <th>DETALLE</th>
                ...
                <?php case ('auxiliar_tipo_documento'): ?>
                    <tr>
                        <th>FECHA</th>
                        <th>DOCUMENTO</th>
                        <th>DETALLE</th>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $cuentas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $puc => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($tipo_balance == 'auxiliar_cuentas_detalles'): ?>
                    <tr>
                        <td colspan="7" style="font-weight: bold; text-align: left; background-color: #f2f2f2">
                            <?php echo e($data['cuenta_tatarabuelo'] ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td colspan="7" style="font-weight: bold; text-align: left; background-color: #f2f2f2">
                            <?php echo e($data['cuenta_bisabuelo'] ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td colspan="7" style="font-weight: bold; text-align: left; background-color: #f2f2f2">
                            <?php echo e($data['cuenta_abuelo'] ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        <td colspan="7" style="font-weight: bold; text-align: left; background-color: #f2f2f2">
                            <?php echo e($data['cuenta_padre'] ?? 'N/A'); ?></td>
                    </tr>
                <?php endif; ?>
                <?php if($tipo_balance == 'auxiliar_tipo_documento'): ?>
                    <tr>
                        <td colspan="7" style="text-align: left; background-color: #f2f2f2">
                            <strong>
                                DOCUMENTO: <?php echo e($puc); ?>
                ...
                <?php endif; ?>
                <tr>
                    <?php if($tipo_balance == 'auxiliar_cuentas' || $tipo_balance == 'auxiliar_cuentas_detalles'): ?>
...
<?php /**PATH /Users/macbook/Herd/SiamERP/resources/views/excel/auxiliares.blade.php ENDPATH**/ ?>