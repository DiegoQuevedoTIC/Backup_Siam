...
<body>
    ...
    <div>BALANCE DE PRUEBA POR <?php echo e($nombre_compania); ?></div>

    <div>
        <p><strong>FONDEP</strong></p>
        <p>Grupo : <?php echo e($nombre_compania); ?></p>
        <p>Rango : <?php echo e($fecha_inicial); ?> hasta <?php echo e($fecha_final); ?></p>
            ...
            <?php switch($tipo_balance):
                ...
                <?php case ('balance_comparativo'): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($total_saldo > 0): ?>
                                    <?php echo e(number_format(($cuenta->saldo / $total_saldo) * 100, 2)); ?>%
                                <?php else: ?>
                                    0%
                                <?php endif; ?>
                            </td>
                    ...
                    <tr class="total">
                        ...
                        <td><strong><?php echo e($total_saldo); ?></strong></td>
                        <td>100%</td>
                    </tr>
                <?php break; ?>
                ...
                <?php default: ?>
                    ...
                    <tr class="total">
                        ...
                        <td><strong><?php echo e(number_format($total_saldo_anteriores, 2)); ?></strong></td>
                        <td><strong><?php echo e(number_format($total_debitos, 2)); ?></strong></td>
                        <td><strong><?php echo e(number_format($total_creditos, 2)); ?></strong></td>
                        <td><strong><?php echo e(number_format($total_saldo_nuevo, 2)); ?></strong></td>
                    </tr>
...
<?php /**PATH /Users/macbook/Herd/SiamERP/resources/views/pdf/balance-general.blade.php ENDPATH**/ ?>