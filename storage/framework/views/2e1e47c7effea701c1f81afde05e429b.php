                        ...
                        >
                            ...
                            <?php if($isReorderableWithDragAndDrop || $isReorderableWithButtons || filled($itemLabel) || $isCloneable || $isDeletable || $isCollapsible): ?>
								<td class="flex items-center gap-x-3 py-2 max-w-20">
                                    ...
                                    <?php if($isCloneable || $isDeletable ): ?>
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Herd/SiamERP/vendor/icetalker/filament-table-repeater/resources/views/table-repeater.blade.php ENDPATH**/ ?>