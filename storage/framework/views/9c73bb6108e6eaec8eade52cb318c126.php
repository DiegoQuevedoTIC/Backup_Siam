...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['wire:loading.class' => 'pointer-events-none opacity-70','wire:click' => 'exportPDF']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:loading.class' => 'pointer-events-none opacity-70','wire:click' => 'exportPDF']); ?>
            Generar reporte
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Herd/SiamERP/resources/views/custom/consultas/saldo-conciliado.blade.php ENDPATH**/ ?>