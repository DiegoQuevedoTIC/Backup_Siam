...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['style' => 'float: right;','onclick' => 'imprimirDiv()','class' => 'button','icon' => 'heroicon-m-printer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['style' => 'float: right;','onclick' => 'imprimirDiv()','class' => 'button','icon' => 'heroicon-m-printer']); ?>
            Imprimir
...
<?php endif; ?>
        ...
        <?php if(isset($this->getRecord()->tipo_documento_contables_id) &&
        ...
        <?php if(count($lineas = $this->getRecord()->comprobanteLinea)): ?>
            <table class="table">
                <thead>
                    <tr>
                        <th>Cuenta</th>
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Herd/SiamERP/resources/views/custom/comprobante/view-comprobante.blade.php ENDPATH**/ ?>