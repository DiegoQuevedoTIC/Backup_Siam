            ...
            Livewire.hook('commit', ({ component, commit, succeed, fail, respond }) => {
                succeed(({ snapshot, effect }) => {
                    $nextTick(() => {
                        ...
                        let newState = $refs.newState.value?.toString().replaceAll('<?php echo e($thousandSeparator); ?>','').replaceAll('<?php echo e($decimalSeparator); ?>','.')

                        if (state?.toString().replaceAll('<?php echo e($thousandSeparator); ?>','').replaceAll('<?php echo e($decimalSeparator); ?>','.') === newState) {
                            return
                        }
...
>
    <input
            type="hidden"
            value="<?php echo e(str($state)->replace('"', '\\"')->replace(',','')); ?>"
            x-ref="newState"
    />
...
<?php /**PATH /Users/macbook/Herd/SiamERP/vendor/ariaieboy/filament-currency/resources/views/text-input-column.blade.php ENDPATH**/ ?>