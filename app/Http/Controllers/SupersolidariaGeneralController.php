...
class CentralesGeneralController extends Controller
{
    //
    ...
    function generarCentralesHorizontal(Request $request)
    {
        try {
            ...
            $excelFile = Excel::raw(new CentralesExport($data), \Maatwebsite\Excel\Excel::XLSX);
    ...
    function generateCentralesTercero(Request $request)
    {
        try {
            $fecha_inicial = $request->fecha_inicial;
            $fecha_final = $request->fecha_final;
    ...
    function generateCentralesComparativo(Request $request)
    {
        try {
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(new CentralesExport($tipo_balance, $fecha_inicial, $fecha_final), $nombre);
    }
