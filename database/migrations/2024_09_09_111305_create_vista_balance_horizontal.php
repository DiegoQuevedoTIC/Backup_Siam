...
return new class extends Migration
{
    ...
    {
        DB::statement("
        CREATE MATERIALIZED VIEW vista_balance_horizontal AS
        ...
        SELECT
            ...
            COALESCE((SELECT sp.saldo FROM saldo_pucs sp WHERE sp.puc = cj.puc ORDER BY sp.amo DESC LIMIT 1), 0.00) AS saldo
        FROM
    ...
    {
        DB::statement("DROP MATERIALIZED VIEW vista_balance_horizontal");
    }
};
