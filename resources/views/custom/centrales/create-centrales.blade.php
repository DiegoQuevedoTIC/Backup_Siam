<div>
    <h2 class="text-center text-xl font-bold mb-4 mt-6" style="font-size: 32px;">Informe Centrales de Riesgo</h2>
                    ...
                    <div class="mb-6 mt-3">
                        ...
                        <x-filament::input.wrapper>
                            <x-filament::input.select id="tipo_balance" name="tipo_balance" required>
                                ...
                                <option value="1">DataCredito</option>
                                <option value="2">Trasunion</option>
                                <option value="3">Procredito</option>
