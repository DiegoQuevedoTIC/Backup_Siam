<div>
    <h2 class="text-center text-xl font-bold mb-4 mt-6" style="font-size: 32px;">Informes Supersolidaria</h2>
                    ...
                    <div class="mb-6 mt-3">
                        ...
                        <x-filament::input.wrapper>
                            <x-filament::input.select id="tipo_balance" name="tipo_balance" required>
                                ...
                                <option value="1">Balance General (Estado de Situación Financiera)</option>
                                <option value="2">Estado de Resultados Integral</option>
                                <option value="3">Estado de Cambios en el Patrimonio</option>
                                <option value="4">Estado de Flujos de Efectivo</option>
                                <option value="5">Notas a los Estados Financieros</option>
                                <option value="6">FUGA (Formulario Único de Gestión Administrativa)</option>
                                <option value="7">Reporte SIREM</option>
                                <option value="8">Informe de Cartera de Créditos</option>
                                <option value="9">Informe de Aportes Sociales</option>
                                <option value="10">Indicadores Financieros</option>
                                <option value="11">Informe de Riesgos (Crédito, Liquidez, Operacional)</option>
                                <option value="12">Informe SARLAFT</option>
                                <option value="13">Informe de Calidad de Cartera</option>
                                <option value="14">Informe de Responsabilidad Social</option>
                                <option value="15">Informe de Cumplimiento Legal</option>
                                <option value="16">Informe de Gestión Administrativa</option>
